...
public class Main {
    public static void main(String[] args) {
        ...
        //        String pathname = "c:/Programowanie/JavaTraining/src/main/resources/exampleFile.txt";
        // jest możliwość podania pełnej ścieżki, ale nie zadziała na innym komputerze
        ...
        Path path0 = Paths.get("src/Main/resources/exampleFile.txt");
        // podanie ścieżki pliku
        Path path1 = Paths.get("src", "Main", "resources", "exampleFile.txt");
        // To samo co wyżej, ale nie martwimy się o obsługę ścieżki przez system operacyjny
